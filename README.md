...
⚠️ Requisitos:
🔑 Para ejecutar la herramienta, debes contar con una API Key de Shodan y una cuenta activa en la plataforma. Puedes obtener una clave en Shodan.io si aún no tienes una.

⚠️ Nota: Este software debe usarse exclusivamente con fines educativos y de auditoría en redes propias o con autorización expresa.
